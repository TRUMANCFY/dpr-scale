...
python $ROOT_DIR/dpr_scale/main.py --config-name msmarco_baseline_contriever_prop_frozen.yaml \
    logger.name=contriever-prop-frozen_ \
    checkpoint_callback.dirpath="$MODEL_DIR"/contriever.prop.frozen/checkpoints
