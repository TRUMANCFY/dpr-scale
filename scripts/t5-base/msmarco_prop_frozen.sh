...
python $ROOT_DIR/dpr_scale/main.py --config-name msmarco_baseline_t5_base_prop_frozen.yaml \
    logger.name=gtr.base.msmarco.prop.frozen \
    checkpoint_callback.dirpath="$MODEL_DIR"/gtr.base.msmarco.prop.frozen/checkpoints
