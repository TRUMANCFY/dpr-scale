...
python $ROOT_DIR/dpr_scale/main.py --config-name msmarco_baseline_t5_base_updated.yaml \
    logger.name=gtr.base.msmarco.updated \
    checkpoint_callback.dirpath="$MODEL_DIR"/gtr.base.msmarco.updated/checkpoints
